...
if sucesso:
    ...
    print("Não foi possível processar o pedido.")

# realizar um pagamento
pagamento = Pagamento(total, "dinheiro")
pagamento.processar_pagamento()

# Neste exemplo, foi criado um pedido com três itens (2 unidades de arroz, 3 unidades de feijão e 4 unidades de macarrão), totalizando R$ 62,00. Depois, o pedido foi processado (atualizando o estoque dos produtos) e, por fim, foi realizado um pagamento
